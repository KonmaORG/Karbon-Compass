            ...
            {[
              {
                id: 1,
                severity: "high",
                issue: "Potential double-counting of credits",
                project: "Solar Farm Project #12",
              },
              {
                id: 2,
                severity: "medium",
                issue: "Unusual transaction pattern detected",
                project: "Reforestation Initiative #8",
              },
              {
                id: 3,
                severity: "low",
                issue: "Unverified data source",
                project: "Energy Efficiency Program #15",
              },
            ].map((alert) => (
              <div
                key={alert.id}
