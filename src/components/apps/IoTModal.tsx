      ...
      <DialogContent className="sm:max-w-[550px]">
        ...
        {action === "connect" ? (
          <div className="space-y-4">
            ...
            <div className="bg-muted p-3 rounded-md">
              <p className="text-sm">
                <strong>Note:</strong> Connecting new devices may require
                additional configuration via the device's management interface.
              </p>
            </div>
          </div>
        ) : deviceData ? (
          <div className="space-y-4">
            ...
            <div className="h-40 border rounded-md flex items-center justify-center bg-muted/50">
              <p className="text-sm text-muted-foreground">
                Emissions chart would be displayed here
              </p>
            </div>
          </div>
        ) : null}
        ...
        <DialogFooter>
          ...
          {action === "connect" && (
            ...
            >
              Connect {selectedDevices.length}{" "}
