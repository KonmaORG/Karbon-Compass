      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Your Carbon Footprint</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {[
                ...
                <div key={i} className="space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{emission.category}</span>
                    <div className="flex items-center">
                      <span className="text-sm mr-2">{emission.amount} tons</span>
                      <span className="text-xs text-muted-foreground">({emission.percentage}%)</span>
                    </div>
                  </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Carbon credits matched to your footprint</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
            ...
            <Button variant="outline" className="w-full mt-4">View All Offset Options</Button>
          </CardContent>
        </Card>
      </div>
    </div>
