...
const GovernanceApp = () => {
  ...
  const [modalAction, setModalAction] = useState<"create" | "vote" | "details">("create");
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { id: 1, title: 'Update Carbon Credit Verification Standards', category: 'Protocol Standards', votes: { for: 65, against: 35 }, days: 3 },
              { id: 2, title: 'Add New Project Category: Blue Carbon', category: 'Protocol Expansion', votes: { for: 82, against: 18 }, days: 5 },
              { id: 3, title: 'Increase Validator Requirements', category: 'Validator Rules', votes: { for: 48, against: 52 }, days: 2 }
            ].map((proposal) => (
