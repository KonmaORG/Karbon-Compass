          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Popular credits available for purchase
                </CardDescription>
              </CardHeader>
              <CardContent>
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <CardDescription className="text-xs">
                              {credit.location} • Verified by{" "}
                              {credit.id % 3 === 0 ? "Gold Standard" : "Verra"}
                            </CardDescription>
                          </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your verified carbon projects eligible for listing
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Credits currently available on the marketplace
                </CardDescription>
              </CardHeader>
              <CardContent>
                {sellerListings.length > 0 ? (
                    ...
                    <TableBody>
                      {sellerListings.map((listing) => (
                        <TableRow key={listing.id}>
                          <TableCell className="font-medium">
                            {listing.projectName || listing.name}
                          </TableCell>
                          <TableCell>
                            ${listing.price.toFixed(2)} per tCO₂e
                          </TableCell>
                          <TableCell>
                            {listing.amountListed.toLocaleString()} tCO₂e
                          </TableCell>
                          <TableCell>
                            {listing.amountSold.toLocaleString()} tCO₂e
                          </TableCell>
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm">
                      Start selling carbon credits by listing your verified
                      projects
                    </p>
                  </div>
                )}
      ...
      <Dialog open={listingModalOpen} onOpenChange={setListingModalOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new listing to sell your verified carbon credits on the
              marketplace.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewListing({ ...newListing, amount: e.target.value })
                }
              />
            </div>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewListing({ ...newListing, validatorName: value })
                }
              >
                <SelectTrigger className="col-span-3">
