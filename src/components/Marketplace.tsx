      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
            Trade verified carbon credits on our transparent, decentralized
            marketplace with real-time pricing and automatic settlement.
          </p>
        </div>
          ...
          <TabsContent value="buy">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {carbonCredits.map((credit) => (
                <Card
                  key={credit.id}
                  className="overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-[1.01]"
                >
                  <CardHeader className="p-4 pb-2">
                    <div className="flex justify-between items-start">
                      ...
                      {credit.verified && (
                        <Badge
                          variant="outline"
                          className="flex items-center gap-1 bg-karbon-50 dark:bg-karbon-900 text-karbon-600 dark:text-karbon-400"
                        >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div>
                        ...
                        <p className="font-semibold">
                          ${credit.price}{" "}
                          <span className="text-xs font-normal">per tCO₂e</span>
                        </p>
                      </div>
                      <div>
                  ...
                  <CardFooter className="p-4 pt-0">
                    <Button
                      variant="default"
                      className="w-full bg-karbon-600 hover:bg-karbon-700 text-white"
                    >
                      Purchase Credits
                    </Button>
                  </CardFooter>
          ...
          <TabsContent value="sell">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto mb-6">
                Create listings for your verified carbon projects and connect
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              <div className="text-center p-6 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-lg border border-karbon-100 dark:border-karbon-800">
                ...
                <p className="text-sm text-foreground/70">
                  Register your carbon project and complete the verification
                  process.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-lg border border-karbon-100 dark:border-karbon-800">
                ...
                <p className="text-sm text-foreground/70">
                  Set your price, available quantity, and add details about your
                  carbon credits.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-lg border border-karbon-100 dark:border-karbon-800">
                ...
                <p className="text-sm text-foreground/70">
                  Receive payments directly when buyers purchase your carbon
                  credits.
                </p>
              </div>
            </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-lg border border-karbon-100 dark:border-karbon-800 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-foreground/70">
                All carbon projects undergo rigorous verification through IoT
                data and trusted validators.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-karbon-100 dark:bg-karbon-800 flex items-center justify-center mx-auto mb-3">
              ...
              <p className="text-sm text-foreground/70">
                Carbon credits are tokenized on blockchain for transparent
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-foreground/70">
                Automated settlement ensures immediate transfer of credits upon
                purchase.
              </p>
            </div>
          </div>
